...
function _getRootNode(rootId, rootProps, parentSelector) {
  ...
  var body = document.querySelector(parentSelector);
...
function mounter(layoutClass, regions, options) {
  _ready(function () {
    ...
    var rootNode = _getRootNode(rootId, rootProps, parentSelector);
